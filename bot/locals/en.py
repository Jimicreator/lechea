...
LOCAL = Local({
    ...
    'WELCOME_MESSAGE' : "Hello 🤩!\nI'm <b>Torrent Leecher Bot</b>!\nMade With Pure ❤️by Jimi Bots.\nChannel😎: <a href='https://t.me/Jimi_Bot'>Jimi_Bots</a>",
    ...
    'ARIA2_DOWNLOAD_CANCELED' : 'Download cancelled🙄: <code>{name}</code>',
    'ARIA2_DEAD_LINK' : 'Download auto canceled : <code>{name}</code>\nYour Torrent/Link is Dead. Bcz I Can't Work With This.',
    'ARIA2_NO_URI' : 'Link invalid😡.',
